    ...
    <section className="relative z-10 h-full min-h-0 overflow-hidden rounded-[28px] border border-white/10 bg-black/20 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
      ...
      <div className="pointer-events-none absolute inset-x-3 top-3 bottom-3 flex flex-col justify-between sm:inset-x-4 sm:top-4 sm:bottom-4">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
          <div className="pointer-events-auto flex max-w-[min(780px,100%)] flex-col gap-3">
            <div className="flex flex-wrap items-center gap-2">
              <div className="rounded-full border border-white/10 bg-[rgba(5,10,18,0.74)] px-3 py-1.5 text-[11px] tracking-[0.18em] text-[var(--text-secondary)] uppercase shadow-[0_10px_28px_rgba(0,0,0,0.24)] backdrop-blur-xl">
                {scene.nodes.length} athletes · {scene.edges.length} matches
              </div>
              <button
                type="button"
                className="rounded-full border border-white/10 bg-[rgba(5,10,18,0.74)] px-3 py-1.5 text-[11px] tracking-[0.18em] text-white uppercase shadow-[0_10px_28px_rgba(0,0,0,0.24)] backdrop-blur-xl transition hover:bg-[rgba(8,14,24,0.84)]"
          ...
          <div className="pointer-events-auto flex flex-wrap gap-2 xl:max-w-[220px] xl:flex-col xl:items-end">
            <button
              ...
              className="rounded-full border border-white/10 bg-[rgba(5,10,18,0.74)] px-3 py-2 text-left shadow-[0_12px_32px_rgba(0,0,0,0.28)] backdrop-blur-xl transition hover:bg-[rgba(8,14,24,0.84)]"
              onClick={() => {
        ...
        {notesOpen ? (
          <div className="pointer-events-auto absolute top-16 right-0 w-[min(320px,calc(100vw-1.5rem))] rounded-[24px] border border-white/10 bg-[rgba(5,10,18,0.92)] p-5 shadow-[0_20px_70px_rgba(0,0,0,0.42)] backdrop-blur-xl sm:top-[4.5rem]">
